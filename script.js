...
function getRandomColors() {
  var colorCount = Math.random() > 0.5 ? 1 : 3;
  var colors = [];
...
for (i = 0; i < v;) {
  ...
  var colorIndex = Math.floor(R() * colors.length);
  var H = colors[colorIndex].H;
  var S = colors[colorIndex].S;
  var B = colors[colorIndex].B;
